...
import net.brusselsprout.sotw.world.WorldGenTreesBanana;
...
public class BlockSaplingBanana extends BlockBush implements IGrowable {

    private static final String name = "sapling_banana";
    ...
    @Override
    public BlockSaplingBanana setCreativeTab(CreativeTabs tab) {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        WorldGenerator worldgenerator = new WorldGenTreesBanana(true);
