...
public class BlockLeavesBanana extends BlockLeaves {

    private static final String name = "leaves_banana";

    /**
     * Instantiates a new block leaves banana.
     */
    public BlockLeavesBanana()
    {
        SproutOTW.proxy.setGraphicsLevel(this, true);
    ...
    @Override
    public BlockLeavesBanana setCreativeTab(CreativeTabs tab) {
    ...
    {
        return Item.getItemFromBlock(ModBlocks.sapling_banana);
    }
