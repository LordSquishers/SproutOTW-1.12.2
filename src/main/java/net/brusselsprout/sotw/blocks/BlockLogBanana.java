...
import net.brusselsprout.sotw.block.BlockBase;
...
public class BlockLogBanana extends BlockLog {

    private static final String name = "log_banana";

    public BlockLogBanana() {
    ...
    @Override
    public BlockLogBanana setCreativeTab(CreativeTabs tab) {
